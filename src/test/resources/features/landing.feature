Feature: landing page 
  ...
  Scenario: the client want have a look of "Lista de Elecciones"
  	When the client click on the link "Lista de Elecciones"
  	Then the client makes call to Lista de Elecciones GET /listaElecciones.xhtml
  	And the client receives Lista de Elecciones status code of 200
  	
  Scenario: the client want see "Referendum" of "Tipos de Elecciones"
  	When the client choose "Referendum"
  ...
  Scenario: the client want see "Listas Cerradas" of "Tipos de Elecciones"
  	When the client choose "Listas Cerradas"
  ...
  Scenario: the client want see "Listas Abiertas" of "Tipos de Elecciones"
  	When the client choose "Listas Abiertas"
