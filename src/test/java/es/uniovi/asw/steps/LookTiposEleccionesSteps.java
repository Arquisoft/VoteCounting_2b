...
public class LookTiposEleccionesSteps {
	...
	public void el_cliente_elije_aquella_que_sea_de_su_interes() throws Throwable {
		...
		// new
		// Select(driver.findElement(By.name("bcarPool_length"))).selectByVisibleText("25");
		// new
		// Select(driver.findElement(By.name("bcarPool_length"))).selectByVisibleText("50");
		// new
		// Select(driver.findElement(By.name("bcarPool_length"))).selectByVisibleText("100");
		// driver.findElement(By.cssSelector("th.sorting_asc")).click();
		// driver.findElement(By.cssSelector("th.sorting")).click();
